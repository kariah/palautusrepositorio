    ...
    <div style={blogStyle}>
      ...
      <div>
        <div style={hideBlogDetailsWhenVisible}>
          <button  className='view-button' onClick={() => setBlogDetailsVisible(true)}>View</button>
        </div>
        <div style={showBlogDetailsWhenVisible}>
          <div className='url'>{blog.url}</div>
          <div className='likes'>likes {blog.likes} <button className='update-likes-button'  onClick={updateLikes}>like</button></div>
          <div>
