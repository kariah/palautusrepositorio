...
beforeEach(async () => {
  ...
  token = await helper.createToken(testUser) 
  initialBlogs = helper.createInitialBlogs(testUser) 
...
describe('viewing blogs and content', () => {
  //Tehtävä 4.8
...
describe('Adding and updating blogs', () => {
  //Tehtävä 4.10
...
//Tehtävä 4.23
  test.only('blog cannot be added without token', async () => {
    const newBlog = {
      title: "React patterns",
      author: "Michael Chan (test, add new)",
      url: "https://reactpatterns.com/",
